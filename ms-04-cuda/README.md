...
|---|---|
| `cu-03-indexation` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article<br>[a-hamdi/GPU](https://github.com/a-hamdi/GPU) · repo |
| `cu-04-coalescence` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article<br>[JINO-ROHIT/kernels/cuda](https://github.com/JINO-ROHIT/kernels/tree/main/cuda) · repo |
| `cu-05-tiling` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article<br>[MIT 6.S894 Accelerated Computing, les labs](https://accelerated-computing.academy/fall25/labs/) · assignment<br>[JINO-ROHIT/kernels/cuda/matmul](https://github.com/JINO-ROHIT/kernels/tree/main/cuda/matmul) · repo<br>[JINO-ROHIT/Flash-Attention-Series/02-tiling](https://github.com/JINO-ROHIT/Flash-Attention-Series/tree/main/02-tiling) · repo |
| `cu-06-reduction` | [JINO-ROHIT/kernels/cuda/reduction](https://github.com/JINO-ROHIT/kernels/tree/main/cuda/reduction) · repo<br>[a-hamdi/GPU](https://github.com/a-hamdi/GPU) · repo |
| `cu-07-occupancy` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article<br>[MIT 6.S894 Accelerated Computing, les labs](https://accelerated-computing.academy/fall25/labs/) · assignment |
| `cu-08-nsight-compute` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article |
| `cu-09-roofline` | [Harvard CS249r, Machine Learning Systems at Scale, chapitre Performance Engineering](https://mlsysbook.ai/vol2/performance_engineering/performance_engineering.html) · book |
| `cu-11-assembleur` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article<br>[JINO-ROHIT/kernels/cuda/matmul/01_naive_ptx.cu](https://github.com/JINO-ROHIT/kernels/blob/main/cuda/matmul/01_naive_ptx.cu) · repo |
| `cu-10-battre` | [Boehm, How to Optimize a CUDA Matmul Kernel for cuBLAS-like Performance: a Worklog](https://siboehm.com/articles/22/CUDA-MMM) · article<br>[MIT 6.S894 Accelerated Computing, les labs](https://accelerated-computing.academy/fall25/labs/) · assignment<br>[JINO-ROHIT/kernels/cute_dsl/matmul](https://github.com/JINO-ROHIT/kernels/tree/main/cute_dsl/matmul) · repo<br>[a-hamdi/GPU](https://github.com/a-hamdi/GPU) · repo |
| `cpp-06-exceptions` | [Anciens sujets 42, CPP Module 05](https://projects.intra.42.fr/projects/cpp-module-05) · assignment<br>[cppreference, exceptions](https://en.cppreference.com/w/cpp/language/exceptions) · docs<br>[cppreference, std::exception](https://en.cppreference.com/w/cpp/error/exception) · docs<br>[ISO C++, FAQ exceptions](https://isocpp.org/wiki/faq/exceptions) · article<br>[Stroustrup, Exception Safety: Concepts and Techniques](https://www.stroustrup.com/except.pdf) · paper |
| `cpp-07-casts` | [Anciens sujets 42, CPP Module 06](https://projects.intra.42.fr/projects/cpp-module-06) · assignment<br>[cppreference, static_cast](https://en.cppreference.com/w/cpp/language/static_cast) · docs<br>[cppreference, reinterpret_cast](https://en.cppreference.com/w/cpp/language/reinterpret_cast) · docs<br>[cppreference, dynamic_cast](https://en.cppreference.com/w/cpp/language/dynamic_cast) · docs<br>[cppreference, std::strtod](https://en.cppreference.com/w/cpp/string/byte/strtof) · docs<br>[ISO C++, FAQ casts](https://isocpp.org/wiki/faq/coding-standards#casts) · article |
| `cpp-08-templates` | [Anciens sujets 42, CPP Module 07](https://projects.intra.42.fr/projects/cpp-module-07) · assignment<br>[cppreference, templates](https://en.cppreference.com/w/cpp/language/templates) · docs<br>[cppreference, class template](https://en.cppreference.com/w/cpp/language/class_template) · docs<br>[cppreference, new expression, initialisation](https://en.cppreference.com/w/cpp/language/new) · docs<br>[ISO C++, FAQ templates](https://isocpp.org/wiki/faq/templates) · article |
| `cpp-09-conteneurs` | [Anciens sujets 42, CPP Module 08](https://projects.intra.42.fr/projects/cpp-module-08) · assignment<br>[cppreference, la bibliothèque des conteneurs](https://en.cppreference.com/w/cpp/container) · docs<br>[cppreference, std::find](https://en.cppreference.com/w/cpp/algorithm/find) · docs<br>[cppreference, std::stack](https://en.cppreference.com/w/cpp/container/stack) · docs<br>[cppreference, std::sort](https://en.cppreference.com/w/cpp/algorithm/sort) · docs<br>[Stroustrup, The C++ Programming Language, chapitre STL](https://www.stroustrup.com/4th.html) · book |
| `cpp-10-stl` | [Anciens sujets 42, CPP Module 09](https://projects.intra.42.fr/projects/cpp-module-09) · assignment<br>[cppreference, std::map](https://en.cppreference.com/w/cpp/container/map) · docs<br>[cppreference, std::stack](https://en.cppreference.com/w/cpp/container/stack) · docs<br>[Knuth, The Art of Computer Programming, vol. 3, 5.3.1, merge insertion](https://www-cs-faculty.stanford.edu/~knuth/taocp.html) · book<br>[Ford et Johnson, A Tournament Problem, 1959](https://doi.org/10.2307/2308750) · paper<br>[OEIS, suite de Jacobsthal A001045](https://oeis.org/A001045) · docs |
