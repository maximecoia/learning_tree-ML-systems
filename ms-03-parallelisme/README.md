...
|---|---|
| `c-11-simd` | [stanford-cs149/asst1](https://github.com/stanford-cs149/asst1) · [CS149 Stanford, cours 2, A Modern Multi-Core Processor](https://gfxcourses.stanford.edu/cs149/fall23/lecture/multicore/) · [Clang, Auto-Vectorization](https://llvm.org/docs/Vectorizers.html) · [stanford-cs149/asst1/prog2_vecintrin/CS149intrin.h](https://github.com/stanford-cs149/asst1/blob/master/prog2_vecintrin/CS149intrin.h) · [McCalpin, STREAM benchmark](https://www.cs.virginia.edu/stream/) · [Williams, Waterman, Patterson, Roofline: An Insightful Visual Performance Model, 2009](https://doi.org/10.1145/1498765.1498785) · [MIT 6.S894 Accelerated Computing, les labs](https://accelerated-computing.academy/fall25/labs/) · [JINO-ROHIT/c-gym/neon_simd](https://github.com/JINO-ROHIT/c-gym/tree/main/neon_simd) |
| `c-12-ordonnancement` | [stanford-cs149/asst2](https://github.com/stanford-cs149/asst2) · [CS149 Stanford, cours 4, Parallel Programming Basics](https://gfxcourses.stanford.edu/cs149/fall23/lecture/progbasics/) · [CS149 Stanford, cours 5, Performance Optimization I, Work Distribution and Scheduling](https://gfxcourses.stanford.edu/cs149/fall23/lecture/perfopt1/) · [pthread_cond_wait, manuel](https://man7.org/linux/man-pages/man3/pthread_cond_wait.3p.html) · [Blumofe et Leiserson, Scheduling Multithreaded Computations by Work Stealing, 1999](https://doi.org/10.1145/324133.324234) · [ThreadSanitizer, manuel Clang](https://clang.llvm.org/docs/ThreadSanitizer.html) |
| `par-05-philosophes-warps` | [NVIDIA, CUDA C++ Programming Guide, SIMT Architecture](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#simt-architecture) · [Lindholm et al., NVIDIA Tesla: A Unified Graphics and Computing Architecture, 2008](https://doi.org/10.1109/MM.2008.31) · [CS149 Stanford, cours 2 et 3, modèles d'exécution parallèle](https://gfxcourses.stanford.edu/cs149/fall23/lecture/) · [Ancien sujet 42, philosophers](https://projects.intra.42.fr/projects/philosophers) · [Harris, Optimizing Parallel Reduction in CUDA](https://developer.download.nvidia.com/assets/cuda/files/reduction.pdf) |
| `cu-01-bases` | [stanford-cs149/asst3](https://github.com/stanford-cs149/asst3) · [CS149 Stanford, cours 7, GPU Architecture and CUDA Programming](https://gfxcourses.stanford.edu/cs149/fall23/lecture/gpucuda/) · [NVIDIA, CUDA C++ Programming Guide](https://docs.nvidia.com/cuda/cuda-c-programming-guide/) · [Harris, Sengupta, Owens, Parallel Prefix Sum (Scan) with CUDA, GPU Gems 3](https://developer.nvidia.com/gpugems/gpugems3/part-vi-gpu-computing/chapter-39-parallel-prefix-sum-scan-cuda) · [Blelloch, Prefix Sums and Their Applications, 1990](https://www.cs.cmu.edu/~guyb/papers/Ble93.pdf) · [louisdumon/learn/checks/common/cuda_hote.h](https://github.com/louisdumon/learn/blob/main/checks/common/cuda_hote.h) · [MIT 6.S894 Accelerated Computing, les labs](https://accelerated-computing.academy/fall25/labs/) |
| `cu-02-divergence` | [NVIDIA, CUDA Programming Guide, Advanced Kernel Programming](https://docs.nvidia.com/cuda/cuda-programming-guide/03-advanced/advanced-kernel-programming.html) · [NVIDIA, CUDA C++ Best Practices Guide, Branching and Divergence](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/index.html#branching-and-divergence) · [CS149 Stanford, cours 7, GPU Architecture and CUDA Programming](https://gfxcourses.stanford.edu/cs149/fall23/lecture/gpucuda/) · [Harris, Optimizing Parallel Reduction in CUDA](https://developer.download.nvidia.com/assets/cuda/files/reduction.pdf) · [louisdumon/learn/checks/common/cuda_hote.h](https://github.com/louisdumon/learn/blob/main/checks/common/cuda_hote.h) · [MIT 6.S894 Accelerated Computing, les labs](https://accelerated-computing.academy/fall25/labs/) |
| `tri-01-vecadd` | [Tutoriels officiels Triton, vector add](https://triton-lang.org/main/getting-started/tutorials/01-vector-add.html) · [louisdumon/learn/checks/common/triton_hote.py](https://github.com/louisdumon/learn/blob/main/checks/common/triton_hote.py) · [Tillet, Kung, Cox, Triton: An Intermediate Language and Compiler](https://dl.acm.org/doi/10.1145/3315508.3329973) · [JINO-ROHIT/gpt-triton](https://github.com/JINO-ROHIT/gpt-triton) · [a-hamdi/GPU](https://github.com/a-hamdi/GPU) |
| `tri-02-softmax` | [Tutoriels officiels Triton, fused softmax](https://triton-lang.org/main/getting-started/tutorials/02-fused-softmax.html) · [Goldberg, What Every Computer Scientist Should Know About Floating-Point](https://docs.oracle.com/cd/E19957-01/806-3568/ncg_goldberg.html) · [Milakov et Gimelshein, Online normalizer calculation for softmax](https://arxiv.org/abs/1805.02867) · [JINO-ROHIT/Flash-Attention-Series/01-softmax](https://github.com/JINO-ROHIT/Flash-Attention-Series/tree/main/01-softmax) |
| `tri-03-matmul` | [Harvard CS249r, Machine Learning Systems at Scale, chapitre Performance Engineering](https://mlsysbook.ai/vol2/performance_engineering/performance_engineering.html) · [hkproj/triton-flash-attention](https://github.com/hkproj/triton-flash-attention) |
| `inf-07-pagedattention` | [JINO-ROHIT/nano-paged-attention](https://github.com/JINO-ROHIT/nano-paged-attention) · [JINO-ROHIT/ORCA](https://github.com/JINO-ROHIT/ORCA) |
| `inf-08-fragmentation` | [JINO-ROHIT/nano-paged-attention](https://github.com/JINO-ROHIT/nano-paged-attention) |
