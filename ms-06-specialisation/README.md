...
|---|---|
| `num-01-precision` | [MIT 6.5940, TinyML and Efficient AI Computing, Song Han](https://hanlab.mit.edu/courses/2026-fall-65940) · course<br>[JINO-ROHIT/ml-systems-notes/quantization/notes.md](https://github.com/JINO-ROHIT/ml-systems-notes/blob/main/quantization/notes.md) · repo<br>[a-hamdi/GPU](https://github.com/a-hamdi/GPU) · repo |
| `dist-01-multigpu` | [MIT 6.5940, TinyML and Efficient AI Computing, Song Han](https://hanlab.mit.edu/courses/2026-fall-65940) · course<br>[JINO-ROHIT/ml-systems-notes/distributed_techniques](https://github.com/JINO-ROHIT/ml-systems-notes/tree/main/distributed_techniques) · repo<br>[hkproj/torchfeather](https://github.com/hkproj/torchfeather) · repo<br>[hkproj/pytorch-transformer-distributed](https://github.com/hkproj/pytorch-transformer-distributed) · repo |
| `qua-01-evaluation` | [MIT 6.5940, TinyML and Efficient AI Computing, Song Han](https://hanlab.mit.edu/courses/2026-fall-65940) · course<br>[JINO-ROHIT/Embedding-Quantization](https://github.com/JINO-ROHIT/Embedding-Quantization) · repo<br>[hkproj/quantization-notes](https://github.com/hkproj/quantization-notes) · repo |
| `cpp-11-moderne` | [Meyers, Effective Modern C++](https://www.oreilly.com/library/view/effective-modern-c/9781491908419/) · book<br>[Compiler Explorer](https://godbolt.org/) · docs<br>[cppreference, std::memory_order](https://en.cppreference.com/w/cpp/atomic/memory_order) · docs<br>[Preshing, An Introduction to Lock-Free Programming](https://preshing.com/20120612/an-introduction-to-lock-free-programming/) · article<br>[Preshing, Acquire and Release Semantics](https://preshing.com/20120913/acquire-and-release-semantics/) · article<br>[Williams, C++ Concurrency in Action, 2e édition](https://www.manning.com/books/c-plus-plus-concurrency-in-action-second-edition) · book<br>[Carruth, CppCon 2015, Tuning C++: Benchmarks, and CPUs, and Compilers! Oh My!](https://www.youtube.com/watch?v=nXaxk27zwlk) · video<br>[Clang, -Rpass et l'assembleur avec -S](https://clang.llvm.org/docs/UsersManual.html#options-to-emit-optimization-reports) · docs |
| `ops-01-exploitation` | [JINO-ROHIT/advanced_ml/12-ml-systems](https://github.com/JINO-ROHIT/advanced_ml/tree/main/12-ml-systems) · repo<br>[JINO-ROHIT/fastapi_with_celery_redis](https://github.com/JINO-ROHIT/fastapi_with_celery_redis) · repo |
| `dist-02-cs336` | [JINO-ROHIT/ml-systems-notes/distributed_techniques](https://github.com/JINO-ROHIT/ml-systems-notes/tree/main/distributed_techniques) · repo |
